...
type updateReq struct {
	...
	DeltaNum int32 `json:"deltanum"`
}

func updateHandle(c *server.StupidContext) {
	log := c.Log.WithField("func", "cart.updateHandle")
	...
	log.Info("updateHandle enter, req:", string(c.Body))
